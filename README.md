...
Intégration de FTK Imager pour capturer et examiner les disques et supports numériques.

Création d’images forensiques fiables pour préserver l’intégrité des données.

Analyse des fichiers journaux et du trafic réseau

Utilisation de Wireshark pour analyser les paquets réseau et détecter des anomalies ou intrusions.

Extraction et traitement des logs système pour identifier des comportements suspects.

Détection de fichiers malveillants et de virus

Intégration de ClamAV pour scanner les fichiers et détecter tout contenu malveillant.

Génération d’alertes et détails sur les fichiers infectés pour chaque analyse.

Vérification de l’intégrité des fichiers

Calcul automatique des hachages (MD5, SHA-1, SHA-256) pour assurer l’intégrité des fichiers et des images disques.

Interface utilisateur interactive

Affichage clair et structuré des résultats via Angular.

Possibilité de visualiser les rapports détaillés pour chaque analyse.
...
Automatiser des processus complexes d’analyse de systèmes et de réseaux.
